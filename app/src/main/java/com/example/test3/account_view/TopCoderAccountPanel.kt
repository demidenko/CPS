...
class TopCoderAccountPanel(
...
): AccountPanel<TopCoderAccountManager.TopCoderUserInfo>(mainActivity, manager)  {
    ...
    override suspend fun showBigView(fragment: AccountViewFragment<TopCoderAccountManager.TopCoderUserInfo>) {
