...
inline fun<reified T: Enum<T>> CPSDataStore.itemEnum(name: String, defaultValue: T) =
...
inline fun<reified T: Enum<T>> CPSDataStore.itemEnumSet(name: String) =
    object : CPSDataStore.DataStoreItem<Set<T>, Set<String>>() {
